    ...
    <>
      ...
      <article className="grid grid-cols-12 lg:grid-cols-5 place-content-stretch pb-8">
        <span
          ...
          className="cursor-pointer col-span-12 lg:col-span-5 justify-center text-slate-400 m-8 md:m-16"
          color="#94a3b8"
        >
          <FaArrowLeft />
        </span>
        <div className="col-span-1"></div>
        <section className="grid grid-cols-3 col-span-10 lg:col-span-3 border-dashed border-gray-100">
