...
export default function Post(props) {
  ...
  return (
    <>
      ...
      <section className="grid grid-cols-10 lg:grid-cols-12 mb-16 pt-16 place-items-stretch">
      ...
      <div className="flex flex-col align-middle justify-center pt-16 pb-16">
        {loadMore && (
