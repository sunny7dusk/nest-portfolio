...
export default function Intro({ y, prevY }) {
  ...
  return (
    <>
      <div className='w-full flex flex-col bg-[#171A26] justify-center'>
        <div className='self-center w-[50vw]'>
          <span className='ease-in-out duration-300 bg-clip-text text-transparent bg-gradient-to-r from-[#A3767D] via-[#F2CC85] to-[#84B8D9] text-xl sm:text-2xl lg:text-3xl xl:text-4xl 2xl:text-6xl tracking-wide text-center'>
